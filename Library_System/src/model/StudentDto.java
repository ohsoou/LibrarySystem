...
public class StudentDto {
	...
	public StudentDto(int student_num, String student_ssn, String student_name, String student_password,
	...
	public String toString() {
		return String.format("%d/%s/%s/%s/%s/%s/%s",
				student_num,student_ssn,student_name,student_password,
				student_address,student_email,student_phone);
	}
}
